...
export const Hero = () => {
  return (
    <section className="h-[440px] w-full  bg-W100 overflow-hidden sm:h-full sm:p-4">
      <div className="max-w-[1116px] mx-auto flex justify-between items-center sm:flex-col-reverse ">
        <div className="translate-y-12 sm:translate-y-2">
        ...
        <div className="relative translate-y-[89px] sm:translate-y-0  ">
          ...
          <Image
            ...
            height={382}
            width={255}
            className="absolute right-0 -top-6 sm:top-0 sm:w-[200px] sm:h-[240px] "
          />
          <Image

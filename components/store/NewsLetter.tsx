  ...
  return (
    <div className={cn("bg-W100 mb-[74px] ", isAuthPage && "hidden")}>
      <div className="max-w-[1116px] mx-auto flex justify-between items-center flex-wrap h-[200px] sm:px-4">
        ...
        <div className="flex items-center gap-4 flex-wrap sm:mt-4">
          <input
            placeholder="Your email address"
            className="border border-slate-200 px-4 h-11 w-[320px] rounded-md  placeholder:text-neutral-500 focus:outline-none focus:border-neutral-black/50 sm:w-full"
          />
